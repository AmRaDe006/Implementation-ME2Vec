...
enc_spec.to_csv('saved_data/.cenc_specsv', index=False)
...
spec_init_emb = med_jny.groupby('patientunitstayid').apply(get_init_emb, emb=X_coor).reset_index(name='embedding') # type: ignore
